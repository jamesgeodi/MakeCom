...
#[derive(Debug)]
pub struct MakeComProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MakeComProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MakeCom processing");
    
    let mut processor = MakeComProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MakeComProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MakeComProcessor::new(false);
